  	...
  	<?php 
		...
		foreach( $fasyankes as $row) : ?>
  		<tr>
  			...
  			<td class="text-center"><?php echo number_format($K=$_SESSION['avg1_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($L=$_SESSION['avg2_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($M=$_SESSION['avg3_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($N=$_SESSION['avg4_3'],2); ?></td>
			
			<td class="text-center"><?php echo number_format($O=$_SESSION['avg5_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($P=$_SESSION['avg6_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($Q=$_SESSION['avg7_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($R=$_SESSION['avg8_3'],2); ?></td>
			
			<td class="text-center"><?php echo number_format($S=$_SESSION['avg9_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($T=$_SESSION['avg10_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($U=$_SESSION['avg11_3'],2); ?></td>
			<td class="text-center"><?php echo number_format($V=$_SESSION['avg12_3'],2); ?></td>
			<!--DC-->
			...
			if($dc1==min($dc1,$dc2,$dc3)){$cls=1; echo '<td class="text-center" style="background-color:green; color:white;"><input type="text" name="tingkat'.$i.'" class="hidden" value="1">1'; } elseif ($dc2==min($dc1,$dc2,$dc3)){$cls=2; echo '<td class="text-center" style="background-color:yellow; color:black;"><input type="text" name="tingkat'.$i.'" class="hidden" value="2">2'; } else {$cls=3; echo '<td class="text-center" style="background-color:red; color:white;"><input type="text" name="tingkat'.$i.'" class="hidden" value="3">3';}?></td>
			<!--Center-->
