...
<div class="page-header">
  <img class="logo" src="../public/icon/puskesmas_hijau.png">
	<label class="judul" align="left">Tambah Fasilitas Pelayanan Kesehatan (Fasyankes)</label>
</div>
  	...
  	<div class="form-group">
		...
		<?php foreach($this->db->get('kecamatan')->result() as $key => $row) : ?>
			<div class="form-check">
		    	<input class="form-check-input" type="radio" value="<?php echo $row->id_kecamatan; ?>" name="kecamatan">
