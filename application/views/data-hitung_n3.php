...
<table class="table table-bordered">
  	...
  	<?php 
		...
		foreach( $fasyankes as $row) : ?>
  		<tr>
  			...
  			<td class="text-center"><?php echo number_format($K=$_SESSION['avg1_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($L=$_SESSION['avg2_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($M=$_SESSION['avg3_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($N=$_SESSION['avg4_2'],2); ?></td>
			
			<td class="text-center"><?php echo number_format($O=$_SESSION['avg5_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($P=$_SESSION['avg6_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($Q=$_SESSION['avg7_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($R=$_SESSION['avg8_2'],2); ?></td>
			
			<td class="text-center"><?php echo number_format($S=$_SESSION['avg9_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($T=$_SESSION['avg10_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($U=$_SESSION['avg11_2'],2); ?></td>
			<td class="text-center"><?php echo number_format($V=$_SESSION['avg12_2'],2); ?></td>
			<!--DC-->
  	...
  	<?php endforeach; ?>
		...
		<td class="text-center"><?php echo number_format($_SESSION['avg1_3']=$H1_SO2020/$ct1,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg2_3']=$H1_RO2020/$ct2,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg3_3']=$H1_SO2021/$ct3,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg4_3']=$H1_RO2021/$ct4,2); ?></td>
		
		<td class="text-center"><?php echo number_format($_SESSION['avg5_3']=$H2_SO2020/$ct5,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg6_3']=$H2_RO2020/$ct6,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg7_3']=$H2_SO2021/$ct7,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg8_3']=$H2_RO2021/$ct8,2); ?></td>
		
		<td class="text-center"><?php echo number_format($_SESSION['avg9_3']=$H3_SO2020/$ct9,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg10_3']=$H3_RO2020/$ct10,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg11_3']=$H3_SO2021/$ct11,2); ?></td>
		<td class="text-center"><?php echo number_format($_SESSION['avg12_3']=$H3_RO2021/$ct12,2); ?></td>
  	</tbody>
</table>
