...
<div class="page-header">
	...
	<label class="judul" align="left">Diagnosa Metode Naive Bayes</label>
...
<table class="table table-bordered">
	...
	<tr>
		...
		<td><?php echo number_format($mean_umur_p=$sm_age/$this->page,4); ?></td>
	</tr>	
	<tr>
...
<p>Umur <?php echo $_POST['umur1'];?> Tahun Dengan Batuk <?php echo $_POST['batuk1'];?> Hari Penurunan berat badan <?php echo $_POST['penurunan1'];?> Sesak Nafas <?php echo $_POST['sesak1'];?> Berkeringat malam <?php echo $_POST['berkeringat1'];?> Batuk Berdarah <?php echo $_POST['batukd1'];?> Demam <?php echo $_POST['demam1'];?></p>
Klasifikasi Umur Dengan Hasil Positif : <?php  echo number_format($AI15=1/sqrt(2*3.14*$deviasi_umur_p)*exp(-(pow($_POST['umur1']-$mean_umur_p,2)/pow($deviasi_umur_p,2))),4);?>
<br>Klasifikasi Umur Dengan Hasil Negatif : <?php  echo number_format($AI17=1/sqrt(2*3.14*$deviasi_umur_n)*exp(-(pow($_POST['umur1']-$mean_umur_n,2)/pow($deviasi_umur_n,2))),4);?>
<br>Klasifikasi Batuk Dengan Hasil Positif	: <?php  echo number_format($AI20=1/sqrt(2*3.14*$deviasi_batuk_p)*exp(-(pow($_POST['batuk1']-$mean_batuk_p,2)/pow($deviasi_batuk_p,2))),4);?>
<br>Klasifikasi Batuk Dengan Hasil Negatif	: <?php  echo number_format($AI22=1/sqrt(2*3.14*$deviasi_batuk_n)*exp(-(pow($_POST['batuk1']-$mean_batuk_n,2)/pow($deviasi_batuk_n,2))),4);?>

<?php

if ($_POST['penurunan1']=="Ya"){ $pb=$N5;}else{$pb=$N6;}
if ($_POST['sesak1']=="Ya"){ $sn=$S5;}else{$sn=$S6;}
if ($_POST['berkeringat1']=="Ya"){ $bm=$X5;}else{$bm=$X6;}
if ($_POST['batukd1']=="Ya"){ $bd=$AC5;}else{$bd=$AC6;}
if ($_POST['demam1']=="Ya"){ $dm=$AH5;}else{$dm=$AH6;}


if ($_POST['penurunan1']=="Ya"){ $pb_n=$O5;}else{$pb_n=$O6;}
if ($_POST['sesak1']=="Ya"){ $sn_n=$T5;}else{$sn_n=$T6;}
if ($_POST['berkeringat1']=="Ya"){ $bm_n=$Y5;}else{$bm_n=$Y6;}
if ($_POST['batukd1']=="Ya"){ $bd_n=$AD5;}else{$bd_n=$AD6;}
if ($_POST['demam1']=="Ya"){ $dm_n=$AI5;}else{$dm_n=$AI6;}
...
<br>Negatif	: <?php echo number_format($AF28=$AI17*$AI22*$pb_n*$sn_n*$bm_n*$bd_n*$dm_n,5); ?>	
        ...
        <h4>Hasil Diagnosa: <?php IF($AF27>$AF28) {echo $hasil="<b>Positif</b>";} else {echo $hasil="<b>Negatif</b>";} ?></h4>    
